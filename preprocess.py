...
sys.path.append('../')
from paths import yangjie_rich_pretrain_unigram_path, yangjie_rich_pretrain_word_path, \
    yangjie_rich_pretrain_char_and_word_path, msra_ner_cn_path
import argparse

parser = argparse.ArgumentParser()
parser.add_argument('--clip_msra', action='store_true', help="适用于MSRA NER数据集")
...
# 读取lexicon_f和char_f，然后输出到output_f
...
print(f"字典生成完成{yangjie_rich_pretrain_char_and_word_path}")
